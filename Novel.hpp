...
//March 19,2023
//Novel.hpp
//This file declares display(), displayFilter() and uses override.
#ifndef NOVEL_HPP_
#define NOVEL_HPP_
...
class Novel : public Book
{
  ...
  */
  ...
  // Example:
  // Enders Game is written by Orson Scott Card. Genre: science fiction. 
  //It has a film adaptation. Page Count: 324. It is not available digitally. 
