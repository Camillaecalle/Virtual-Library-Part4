...
//March 19,2023
//Novel.cpp
//This file implements display() and displayFilter().
#include "Novel.hpp"
...
/**
  ...
  */
void Novel::display() {
    std::cout << getTitle() << " is written by " << getAuthor() << ". " << "Genre: " << getGenre() << (hasFilmAdaptation() ? ". It has a film adaptation. " : ". It does not have a film adaptation. ") << "Page Count: " <<
    getPageCount() << "." << (isDigital() ? " It is " : " It is not ") <<  "available digitally.\n";
}
